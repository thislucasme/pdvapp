...
public class ClientesCartPdvAdapter extends RecyclerView.Adapter<ClientesCartPdvAdapter.MyViewHolder> {

    private List<Cliente> clientes;

    public ClientesCartPdvAdapter(List<Cliente> clientes) {
   ...
   // }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View itemLista = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_clientes_edicao_pdv  , parent, false);
